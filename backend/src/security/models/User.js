// backend/models/User.js - النسخة المتقدمة والمحسنة
  ...
  subscription: {
    ...
    features: {
      ...
      default: function() {
        ...
        const planFeatures = {
          basic: { aiTrading: true, multiExchange: true },
          pro: { aiTrading: true, multiExchange: true, advancedAnalytics: true, apiAccess: true },
          premium: { aiTrading: true, multiExchange: true, advancedAnalytics: true, apiAccess: true, prioritySupport: true, riskManagement: true },
          enterprise: { aiTrading: true, multiExchange: true, advancedAnalytics: true, apiAccess: true, prioritySupport: true, riskManagement: true, customStrategies: true }
        };
...
// === الدوال الافتراضية (Virtuals) المحسنة ===
